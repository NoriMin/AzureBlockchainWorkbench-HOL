...
contract FileRegistry {
    ...
    returns(bool isRegistered) 
  {
    ...
    //Look up to see if this File reg is registered
    function IsRegisteredFileId(string memory FileId)
    public 
    view
    returns(bool isRegistered) 
  {
...
contract File {
	...
	constructor (string memory registryAddress, string memory fileId, string memory location, string memory fileHash, string memory fileMetadataHash, string memory contentType, string memory etag, string memory processedDateTime) public {
		FileId = fileId;
		Location = location;
		FileHash = fileHash;
	...
	function RegisterFile(address registryAddress) public {
	 ...
	 function  Delete(string memory deletionProcessedDateTime) public{
	...
	function stringToAddress(string memory _a) internal returns (address){
